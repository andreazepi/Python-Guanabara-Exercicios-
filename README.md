...
### 1. 📚 Anotações Teóricas Iniciais(`anotacoes/`)
...
### 2. 📦 Módulos e Packages (`aula08_modulos_packages/`)
Conteúdo específico da **Aula 8**, focado em modularização.
- Explicação sobre `import`, `from` e criação de pacotes.
- Exemplos práticos e arquivos de requisitos.

### 3. 💻 Exercícios Resolvidos (`exercicios_resolvidos_001_ao_015/`)
