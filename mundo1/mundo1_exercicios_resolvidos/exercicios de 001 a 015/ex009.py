...
print('-' * 12) #Lembre-se essa primera e ultimo print é só para criar uma linha ---------
print(f'{num} x {1:2} = {num*1}')   #:2 significa que coloquei dois digitos pra ficar mais alinhado no resultado final
